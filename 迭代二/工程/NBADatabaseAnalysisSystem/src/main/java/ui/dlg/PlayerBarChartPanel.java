...
public class PlayerBarChartPanel extends JPanel {
	...
	public PlayerBarChartPanel(int x,int y,int width,int height,String[][] data){
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
...
//	
	...
	PlayerBarChartPanel panel = new PlayerBarChartPanel(0,0,600,700,barChartData);
